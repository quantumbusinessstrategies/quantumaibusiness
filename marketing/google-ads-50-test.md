...
- Do not enable automatic asset creation.
- Do not accept Google recommendations that expand targeting, raise budget, or add broad keywords.
...
- URL options: keep UTM final URLs below

## Ad Group 1: Website Conversion Audit
...
Growth Scan Pack $49.99
Find Missed Follow-Up
Business Automation Audit
...
```txt
Find weak offers, missed follow-up, and unused automation paths. AI-assisted Growth Scan Pack. One-time $49.99.
...
- Pin `Growth Scan Pack $49.99` to Headline position 2 if Google allows it.
- Pin one no-guarantee/practical description if Google allows it.

## Negative Keywords

Add these as phrase negatives:
