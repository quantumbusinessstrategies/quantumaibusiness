...
export default async function handler(req, res) {
  ...
  jsonResponse(res, 200, {
    ...
    owner_notification_provider: configured(process.env.RESEND_API_KEY) ? 'resend' : 'formsubmit',
    owner_notification_target: ownerEmail(),
    owner_notification_endpoint_configured: configured(process.env.OWNER_NOTIFICATION_URL),
